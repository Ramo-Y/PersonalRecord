...
namespace PersonalRecord.Domain.Migrations
{
    ...
    [Migration("20241102115119_AddNavigationPropertyForWorkoutToExercise")]
    partial class AddNavigationPropertyForWorkoutToExercise
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonalRecord.Domain.Models.Entities.WorkoutToExercise", b =>
                {
                    ...
                    b.Property<float>("WteExerciseDistance")
                        .HasColumnType("REAL");
                    ...
                    b.Property<TimeOnly>("WteExerciseTime")
                        .HasColumnType("TEXT");

                    b.Property<float>("WteExerciseWeight")
                        .HasColumnType("REAL");
            ...
            modelBuilder.Entity("PersonalRecord.Domain.Models.Entities.WorkoutToExercise", b =>
                {
                    ...
                    b.HasOne("PersonalRecord.Domain.Models.Entities.Workout", "Workout")
                        .WithMany("WokWorkoutToExerciseItems")
            ...
            modelBuilder.Entity("PersonalRecord.Domain.Models.Entities.Workout", b =>
                {
                    b.Navigation("WokWorkoutToExerciseItems");
                });
