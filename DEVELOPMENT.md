...
# Icons
To add new icons to the user interface, use the Material Design icons from Google Fonts.  They can be downloaded [here](https://fonts.google.com/icons) for free. Use the default settings and always download a dark (#e8eaed) and a light (#000000) theme icon as an SVG file.
